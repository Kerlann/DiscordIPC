...
public final class IPCClient implements Closeable
{
    ...
    public void close()
    {
        ...
        try {
            ...
            System.out.println(String.format("Failed to close pipe", e));
        }
    }
        ...
        readThread = new Thread(() -> {
            try
            {
                ...
                while((p = pipe.read()).getOp() != OpCode.CLOSE)
                {
                    ...
                    if(listener != null && json.has("cmd") && json.getString("cmd").equals("DISPATCH"))
                    {
                        ...
                        {
                            System.out.println(String.format("Exception when handling event: ", e));
                        }
                    }
                }
            ...
            catch(IOException | JSONException ex)
            {
                if(ex instanceof IOException)
                    System.out.println(String.format("Reading thread encountered an IOException", ex));
                else
                    System.out.println(String.format("Reading thread encountered an JSONException", ex));
